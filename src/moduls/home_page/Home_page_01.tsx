    ...
    <div className="min-h-screen bg-gray-50 text-gray-900">
      ...
      <section id="features" className="max-w-6xl mx-auto px-6 pb-24">
        <div className="grid md:grid-cols-3 gap-6">
          <Feature_cards_01 title={"⚽ Player Database"} body={"Browse, search, and manage detailed footballer statistics including goals, assists, age, position, and nationality."} />
          <Feature_cards_01 title={"📊 Clean Stat UI"} body={"Designed with a modern stat-card layout inspired by sports dashboards. Optimized for clarity and fast data comparison."} />
          <Feature_cards_01 title={"🛠 Full Stack Build"} body={"REST API built with Spring Boot connected to MongoDB. Frontend powered by React with dynamic state management."} />
        </div>
      </section>
